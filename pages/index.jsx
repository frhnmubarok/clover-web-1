              ...
              <ul className='slider-container'>
                {images.map((image, i) => (
                  <li key={i} className='rounded-3xl overflow-hidden'>
                    <Image src={image} alt='Image' layout='fill' className='object-cover object-center' />
                  </li>
                ))}
              </ul>
        ...
        <div className='container'>
          ...
          <div className='max-w-7xl overflow-x-hidden'>
            <div className='flex flex-nowrap space-x-5 w-screen'>
              {[1, 2, 3, 4].map((i) => (
                <div key={i} className='relative w-[500px] h-[166px] rounded-2xl overflow-hidden'>
                  <Image
                  ...
                  <h2 className='text-2xl text-white absolute top-5 left-5 w-3/5'>Sayuran Segar Dari Kebun Petani</h2>
                  <button
                    type='button'
