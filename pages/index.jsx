          ...
          <div className="overflow-x-hidden max-w-7xl">
            <div className="flex w-screen space-x-5 flex-nowrap">
              {[1, 2, 3, 4].map((i) => (
                <div
                  key={i}
                  className="relative w-[500px] h-[166px] rounded-lg overflow-hidden"
                >
                  <Image
                  ...
                  <h2 className="absolute w-3/5 text-2xl text-white top-5 left-5">
              ...
              <div className="grid grid-cols-2 sm:grid-cols-3 md:grid-cols-4 lg:grid-cols-5 gap-x-4 gap-y-8 md:gap-8">
                {products.map((product, i) => (
                  <ProductCard
                    ...
                    image={`http://localhost:3000/images/products/jeruk.png`}
                  />
                ))}
              </div>
