...
const DashboardHomepage = ({ user }) => {
  ...
  useEffect(() => {
    axios({
      method: 'GET',
      url: 'https://dev-api-clover.herokuapp.com/api/store',
      headers: {
  ...
  if(store.store_name){
    ...
    return (
      <div className='overflow-auto h-screen pb-24 px-4 md:px-6 font-lato'>
        <h1 className='text-4xl font-semibold text-gray-800 dark:text-white'>Selamat datang, {store.store_name}</h1>
        <h2 className='text-md text-gray-400'>Here&#x27;s what&#x27;s happening with your account today.</h2>
        <div className='flex my-6 items-center w-full space-y-4 md:space-x-4 md:space-y-0 flex-col md:flex-row'>
          <div className='w-full md:w-6/12'>
            <div className='shadow-lg w-full bg-white dark:bg-gray-700 relative overflow-hidden rounded-lg'>
              <div className='flex items-center justify-between px-4 py-6 space-x-4'>
                ...
                <div className='border-b border-gray-200 mt-6 md:mt-0 text-black dark:text-white font-bold text-xl'>
                  {formatRupiah(store.store_total_revenue)}
                  {/* <span className='text-xs text-gray-400'>/$100K</span> */}
                </div>
              </div>
              <div className='w-full h-3 bg-white'>
                <div className='w-2/5 h-full text-center text-xs text-white bg-white'></div>
              </div>
            </div>
          </div>
          <div className='flex items-center w-full md:w-1/2 space-x-4'>
            <div className='w-1/2'>
              <div className='shadow-lg px-4 py-6 w-full bg-white dark:bg-gray-700 rounded-lg relative'>
                <p className='text-2xl text-black dark:text-white font-bold'>{products.length}</p>
                <p className='text-gray-400 text-sm'>Barang yang dijual</p>
              </div>
            </div>
            <div className='w-1/2'>
              <div className='shadow-lg px-4 py-6 w-full bg-white dark:bg-gray-700 rounded-lg relative'>
                <p className='text-2xl text-black dark:text-white font-bold'>
                  {formatRupiah(store.store_total_withdrawals)}<span className='text-xs text-gray-400'>/{formatRupiah(store.store_total_revenue)}</span>
                </p>
    ...
    return(
      <div className='overflow-auto h-screen pb-24 px-4 md:px-6 font-lato'>
        <h1 className='text-4xl font-semibold text-gray-800 dark:text-white'>Selamat datang, </h1>
        <h2 className='text-md text-gray-400'>Here&#x27;s what&#x27;s happening with your account today.</h2>
        <div className='flex my-6 items-center w-full space-y-4 md:space-x-4 md:space-y-0 flex-col md:flex-row'>
          <div className='w-full md:w-6/12'>
            <div className='shadow-lg w-full bg-white dark:bg-gray-700 relative overflow-hidden rounded-lg'>
