  ...
  return (
    ...
    >
      <div className='fixed top-0 right-0'>
        <svg width='657' height='278' viewBox='0 0 657 278' fill='none' xmlns='http://www.w3.org/2000/svg'>
          <path
      ...
      <div className='fixed bottom-0 left-0'>
        <svg width='539' height='491' viewBox='0 0 539 491' fill='none' xmlns='http://www.w3.org/2000/svg'>
          <path
      ...
      <div className='relative container mx-auto flex items-center justify-center'>
        <div className='min-h-screen flex sm:flex-row mx-0 justify-center max-w-xl'>
                  ...
                  {formImage && (
                    <Link href='/'>
                      <a className='cursor-pointer'>
                        <Image src={CloverImage} alt='Picture of the author' width={220} height={78} quality={100} />
                      </a>
                    </Link>
                  )}
                  {formLabel && (
