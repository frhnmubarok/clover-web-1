...
export default function ProductCard({ slug, title, price, owner, rating, soldout, image }) {
  return (
    <div>
      <div className='relative group'>
        <div className='relative w-full overflow-hidden bg-gray-200 min-h-80 aspect-[4/6] rounded-xl'>
          ...
          <div className='absolute flex items-center justify-between w-full px-4 space-x-3 bottom-4'>
            ...
            <button type='button' className='p-2 text-sm text-white bg-primary-500 rounded-xl'>
      ...
      <div className='flex justify-between mt-2'>
        <div>
          ...
          <p className='text-xl font-semibold text-gray-500'>{formatRupiah(price)}</p>
